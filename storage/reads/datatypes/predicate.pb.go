...
func (x *Node) GetStringValue() string {
	if x != nil {
		if x, ok := x.Value.(*Node_StringValue); ok {
...
func (x *Node) GetBooleanValue() bool {
	if x != nil {
		if x, ok := x.Value.(*Node_BooleanValue); ok {
...
func (x *Node) GetIntegerValue() int64 {
	if x != nil {
		if x, ok := x.Value.(*Node_IntegerValue); ok {
...
func (x *Node) GetUnsignedValue() uint64 {
	if x != nil {
		if x, ok := x.Value.(*Node_UnsignedValue); ok {
...
func (x *Node) GetFloatValue() float64 {
	if x != nil {
		if x, ok := x.Value.(*Node_FloatValue); ok {
			return x.FloatValue
		}
	}
	return 0
...
func (x *Node) GetRegexValue() string {
	if x != nil {
		if x, ok := x.Value.(*Node_RegexValue); ok {
			return x.RegexValue
		}
	}
	return ""
...
func (x *Node) GetTagRefValue() string {
	if x != nil {
		if x, ok := x.Value.(*Node_TagRefValue); ok {
...
func (x *Node) GetFieldRefValue() string {
	if x != nil {
		if x, ok := x.Value.(*Node_FieldRefValue); ok {
...
func (x *Node) GetLogical() Node_Logical {
	if x != nil {
		if x, ok := x.Value.(*Node_Logical_); ok {
			return x.Logical
		}
	}
...
func (x *Node) GetComparison() Node_Comparison {
	if x != nil {
		if x, ok := x.Value.(*Node_Comparison_); ok {
			return x.Comparison
		}
	}
...
const file_predicate_proto_rawDesc = "" +
	...
	"RegexValue\x12\"\n" +
	"\vTagRefValue\x18\t \x01(\tH\x00R\vTagRefValue\x12&\n" +
	"\rFieldRefValue\x18\n" +
	...
	"\x05value\"B\n" +
	"\tPredicate\x125\n" +
	"\x04root\x18\x01 \x01(\v2!.influxdata.platform.storage.NodeR\x04rootB\rZ\v.;datatypesb\x06proto3"
