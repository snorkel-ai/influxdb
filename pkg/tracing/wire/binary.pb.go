...
func file_binary_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_binary_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_binary_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Span); i {
			case 0:
				return &v.state
			case 1:
		...
		file_binary_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Trace); i {
			case 0:
				return &v.state
			case 1:
		...
		file_binary_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Field); i {
			case 0:
				return &v.state
			case 1:
	...
	file_binary_proto_msgTypes[3].OneofWrappers = []any{
