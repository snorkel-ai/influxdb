...
func file_internal_fieldsindex_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_internal_fieldsindex_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Series); i {
			case 0:
				return &v.state
			case 1:
		...
		file_internal_fieldsindex_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Tag); i {
			case 0:
				return &v.state
			case 1:
		...
		file_internal_fieldsindex_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_internal_fieldsindex_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Field); i {
			case 0:
				return &v.state
			case 1:
		...
		file_internal_fieldsindex_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_internal_fieldsindex_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_internal_fieldsindex_proto_msgTypes[6].Exporter = func(v any, i int) any {
