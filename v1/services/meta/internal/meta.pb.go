...
const file_internal_meta_proto_rawDesc = "" +
	"\n" +
	...
	"\x11ContinuousQueries\x18\x04 \x03(\v2\x19.meta.ContinuousQueryInfoR\x11ContinuousQueries\"\x91\x01\n" +
	...
	"\bReplicaN\x18\x04 \x01(\rR\bReplicaN\"\x87\x02\n" +
	...
	"\rSubscriptions\x18\x06 \x03(\v2\x16.meta.SubscriptionInfoR\rSubscriptions\"\xc1\x01\n" +
	...
	"\acommand\x12\r.meta.Command\x18\x82\x01 \x01(\v2\x16.meta.DropShardCommandR\acommandB\bZ\x06.;meta"

var (
	file_internal_meta_proto_rawDescOnce sync.Once
	file_internal_meta_proto_rawDescData []byte
)

func file_internal_meta_proto_rawDescGZIP() []byte {
	file_internal_meta_proto_rawDescOnce.Do(func() {
		file_internal_meta_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_internal_meta_proto_rawDesc), len(file_internal_meta_proto_rawDesc)))
	})
...
func file_internal_meta_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_internal_meta_proto_rawDesc), len(file_internal_meta_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   43,
			NumExtensions: 29,
			NumServices:   0,
